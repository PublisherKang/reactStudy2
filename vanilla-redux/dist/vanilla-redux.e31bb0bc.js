...
var btnDecrease = document.querySelector("#decrease"); //액션 정의, 액션 이름은 문자열로, 중복 방지를 위해 고유한 이름으로 대문자를 사용한다.
...
render(); //상태가 업데이트 될때마다 render함수 호출

store.subscribe(render); //구족하기

var listener = function listener() {
  console.log("상태가 업데이트 됨");
};

var unsubscrible = store.subscribe(listener);
unsubscrible(); //액션 발생시키기
